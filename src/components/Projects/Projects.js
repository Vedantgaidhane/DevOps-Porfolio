...
function Projects() {
  return (
    <>
      <Helmet>
        <title>Projects | Vedant Gaidhane</title>
        <meta
          name="description"
          content="Explore DevOps and AWS projects by Vedant Gaidhane, including CI/CD pipelines, Kubernetes deployments, and automation scripts."
        />
      </Helmet>
